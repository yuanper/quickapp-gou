...
(exports.default || module.exports).manifest = {"package":"com.gionee.gou","name":"购物大厅","versionName":"1.0.0","versionCode":"1","minPlatformVersion":"101","icon":"/Common/logo.png","features":[{"name":"system.prompt"},{"name":"system.router"},{"name":"system.shortcut"},{"name":"system.fetch"},{"name":"system.webview"}],"permissions":[{"origin":"*"}],"config":{"logLevel":"debug"},"router":{"entry":"Home","pages":{"Home":{"component":"index"},"Detail":{"component":"index"},"Address":{"component":"index"},"Category":{"component":"index"}}},"display":{"fullScreen":true,"titleBar":false,"titleBarBackgroundColor":"#f2f2f2","titleBarTextColor":"#414141","menu":false,"pages":{"Home":{"titleBar":false,"menu":true},"Detail":{"titleBarText":"详情页","titleBar":true},"Address":{"titleBarText":"新增收货地址","titleBar":true},"About":{"menu":false}}}};
}
...
globalRef.regeneratorRuntime = __webpack_require__(11);
...
// 服务器地址
var SERVER_URL = 'http://apk.gou.3gtest.gionee.com';
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log('开始网络请求');
              url = SERVER_URL + obj.url;
              options = Object.assign(obj, { url: url });
              p1 = new Promise(function (resolve, reject) {

                options.success = function (_ref2) {
                  var data = _ref2.data,
                      code = _ref2.code;
